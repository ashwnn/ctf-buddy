...
def build_release_notes(
    ...
    lines = [
        ...
        "a source-linked knowledge base with local full-text search and cheat sheets,",
        "read-only discovery, a transactional patch engine with rollback, bounded",
        "observation, decoys and honeypot listeners, an optional review-only lockdown",
        "(additive nftables allowlist and sshd key-only hardening), drills, and ssh",
        "remote mode for a declared team-owned host -- including `remote auto`, the",
        "one-command read-only recon pass that ends in a written report.",
        "",
        "## Requirements",
        "",
